...
public class ConcreteSyntaxModel {
    ...
    static {
        ...
        concreteSyntaxModelByClass.put(CompactWithExpression.class, sequence(comment(), child(ObservableProperty.TARGET), string(GeneratedJavaParserConstants.LBRACE), list(ObservableProperty.EXPRESSIONS, sequence(string(GeneratedJavaParserConstants.COMMA), space())), string(GeneratedJavaParserConstants.RBRACE)));
